...
const BiographyCategoryBook = () => {
    ...
    try {
      ...
      if (res.data) {
        const findOne = res.data.find(
          (category) => category.name.toLowerCase() === "biography".toLowerCase()
        );
  ...
  return (
    <div className="p-0">
      {carding && (
        <BookDetailsModal handleDetails={handleDetails} book={currentBook} />
      )}
      <section>
...
export default BiographyCategoryBook;
